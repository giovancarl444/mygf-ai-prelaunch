...
import { filterCatalogWorlds, type CatalogWorld } from "../client/src/lib/catalogFilters";
...
describe("catalog world filtering", () => {
  ...
  it("returns all worlds for default filters and none for an unmatched query", () => {
