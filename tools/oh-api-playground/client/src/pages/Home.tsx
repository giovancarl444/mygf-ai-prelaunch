...
const tabs: { id: TabId; label: string; icon: typeof MessageCircle; endpoint: string }[] = [
  ...
  { id: "audio", label: "Audio", icon: AudioLines, endpoint: "/api/v1/audio" },
